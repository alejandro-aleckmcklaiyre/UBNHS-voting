...
try {
    ...
    $mail->SMTPAuth = true;
    $mail->Username = 'shinken775@gmail.com';
    $mail->Password = 'ouglgudtxwopaysh';
    $mail->SMTPSecure = PHPMailer::ENCRYPTION_STARTTLS;
    $mail->Port = 587;
    $mail->setFrom('shinken775@gmail.com', 'UBNHS Voting System');
    ...
    log_email_attempt(['student_number' => $student['student_number'], 'status' => 'success', 'message' => 'Email sent', 'email' => $student['email']]);
    echo json_encode(['success' => true, 'message' => 'Email sent successfully.']);
} catch (Exception $e) {
    log_email_attempt(['student_number' => $student['student_number'], 'status' => 'fail', 'reason' => 'Mailer Error', 'error' => $e->getMessage()]);
